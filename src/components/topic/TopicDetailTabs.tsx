        ...
        <CardContent className="p-6">
          <div className="space-y-4">
            <Input
              ...
              className="text-lg font-bold border-2 border-primary/30 focus:border-primary"
            />
            <Textarea
        ...
        <CardContent className="p-6">
          <div className="flex flex-col xl:flex-row xl:items-start justify-between gap-4">
            <div className="flex-1 min-w-0">
              <h1 className="text-xl md:text-2xl font-bold text-foreground mb-3 break-words leading-tight">
                {topic.name}
              </h1>
              {topic.description && (
                <div className="mb-4">
      ...
      <Card className="bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-950/20 dark:to-indigo-950/20 border-blue-200 dark:border-blue-800">
        <CardContent className="p-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="text-base font-semibold text-blue-900 dark:text-blue-100">Quick Stats</h3>
          </div>
        ...
        <Card className="border-orange-200 dark:border-orange-800 bg-gradient-to-r from-orange-50 to-amber-50 dark:from-orange-950/20 dark:to-amber-950/20">
          <CardContent className="p-6">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="text-base font-semibold text-orange-900 dark:text-orange-100">Topic Management</h3>
            </div>
    ...
    <div className="flex flex-col h-full overflow-hidden">
      <Tabs value={activeTab} onValueChange={onTabChange} className="flex flex-col h-full overflow-hidden">
        <TabsList className="grid w-full grid-cols-4 mb-6 bg-muted/50 p-1 rounded-lg h-12 md:h-14 flex-shrink-0">
          <TabsTrigger 
            value="overview" 
            className="relative data-[state=active]:bg-background data-[state=active]:text-foreground data-[state=active]:shadow-sm transition-all duration-200 rounded-md text-xs md:text-sm font-medium flex items-center justify-center gap-1 px-2 md:px-4"
          >
            <span className="hidden sm:inline text-sm md:text-base">📋</span>
          ...
          <TabsTrigger 
            ...
            className="relative data-[state=active]:bg-background data-[state=active]:text-foreground data-[state=active]:shadow-sm transition-all duration-200 rounded-md text-xs md:text-sm font-medium flex items-center justify-center gap-1 disabled:opacity-50 disabled:cursor-not-allowed px-2 md:px-4"
          >
            <span className="hidden sm:inline text-sm md:text-base">📂</span>
                ...
                <CardContent className="p-6">
                  <div className="space-y-4">
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      <h3 className="text-base font-semibold text-foreground">About {topic.name}</h3>
                    </div>
                    {topic.description ? (
